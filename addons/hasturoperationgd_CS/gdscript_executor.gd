class_name HasturCSharpGDScriptExecutor
...
func _execute_snippet(instance: RefCounted, execute_context, result: Dictionary) -> void:
	instance.executeContext = execute_context
	instance.run()
	result.run_success = true


func _execute_full_class(instance: RefCounted, execute_context, result: Dictionary) -> void:
