...
description: "Use when the user asks to capture, save, or compare screenshots of the Godot editor or running game window, including requests like screenshot, capture screen, snap viewport, or periodic visual checks. Depends on godot-remote-executor for broker API access."
---
